...
Signal_IR = X169_DE_time; EnvSignal_IR = abs(hilbert(Signal_IR));
Signal_OR = X197_DE_time; EnvSignal_OR = abs(hilbert(Signal_OR));
Signal_B = X222_DE_time; EnvSignal_B = abs(hilbert(Signal_B));
